...
public:
   ...
   private:
																																																																																																																																																																																																																																													template <typename T> string print_array(const vector<T> &V) { ostringstream os;
       os << "{ ";
...
void test_case_0() {
  ...
  string Arg1 = "16";
  string Arg2 = "17";
  verify_case(0, Arg2, nextInteger(Arg0, Arg1));
}
void test_case_1() {
 int Arr0[] = { 0, 1, 2, 3, 4, 5, 6, 8, 9 };
 vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0])));
 string Arg1 = "16";
 string Arg2 = "18";
 verify_case(1, Arg2, nextInteger(Arg0, Arg1));
}
void test_case_2() {
    int Arr0[] = { 3, 5, 8 };
    vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0])));
    string Arg1 = "548";
    string Arg2 = "INVALID INPUT";
    verify_case(2, Arg2, nextInteger(Arg0, Arg1));
}
void test_case_3() {
   int Arr0[] = { 5, 3, 4 };
   vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0])));
   string Arg1 = "033";
   string Arg2 = "INVALID INPUT";
   verify_case(3, Arg2, nextInteger(Arg0, Arg1));
}
void test_case_4() {
  ...
  string Arg1 = "999";
  string Arg2 = "1000";
  verify_case(4, Arg2, nextInteger(Arg0, Arg1));
}
void test_case_5() {
 ...
 string Arg1 = "0";
 string Arg2 = "INVALID INPUT";
 verify_case(5, Arg2, nextInteger(Arg0, Arg1));
}
void test_case_6() {
    int Arr0[] = { 1 };
    vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0])));
    string Arg1 = "1";
    string Arg2 = "11";
    verify_case(6, Arg2, nextInteger(Arg0, Arg1));
}
=======
																																																																																																																																																																																																																											public:
																																																																																																																																																																																																																												void run_test(int Case) {
